...
本仓库按 monorepo 组织，当前阶段已经完成工程骨架、文档模型第一版、model selection 第一版、基础 model 渲染第一版、DOM/model point 映射第一版、selection 双向同步第一版、React 组件 API 第一版和渲染闭环验收。
...
- `apps/demo`：开发与验收入口，当前展示文档模型 JSON、React 组件示例、渲染边界示例和 selection 调试面板。
