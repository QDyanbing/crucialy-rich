...
- History：`createHistorySnapshot`、`cloneHistorySnapshot`、`createHistoryState`、`clearHistory`、`recordHistory`、`canUndo`、`canRedo`、`getUndoEntry`、`getRedoEntry`。
