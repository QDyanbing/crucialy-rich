...
describe("@crucialy-rich/core public API", () => {
  ...
  it("exposes the selection API", () => {
    ...
    expect(typeof core.getBlockTextOffset).toBe("function");
    expect(typeof core.getParagraphTextOffset).toBe("function");
    expect(typeof core.getPointAtBlockTextOffset).toBe("function");
  ...
  it("exposes the operation API", () => {
    ...
    expect(typeof core.createExitListItemOperation).toBe("function");
    expect(typeof core.applyExitListItem).toBe("function");
    expect(typeof core.createSelectionAfterExitListItem).toBe("function");
    ...
    expect(typeof core.createSetTableCellTextOperation).toBe("function");
    expect(typeof core.applySetTableCellText).toBe("function");
  ...
  it("exposes the command API", () => {
    ...
    expect(typeof core.isQuoteCommandActive).toBe("function");
