...
已完成工程初始化、文档模型第一版、model selection 第一版、基础 model 渲染第一版和 DOM/model point 映射第一版。

当前仍未实现 React 富文本组件逻辑、浏览器 selection 同步或真实编辑行为。
...
├── docs                   # 架构、开发和 QA 文档
├── packages/core          # 富文本内核模型、selection、基础渲染和 DOM 映射
