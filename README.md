...
text marks 当前完成 `bold` / `italic` 的模型表达、helper、校验、规范化、operation 保留和 history 快照保留；Bold / Italic command、renderer 标签输出和 demo 工具栏仍是下一步。
