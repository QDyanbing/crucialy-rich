...
text marks 当前完成 `bold` / `italic` 的模型表达、helper、校验、规范化、operation 保留和 history 快照保留；Bold 已具备 command、`toggle_mark`、`<strong>` renderer 输出、demo“加粗”按钮和 history 记录。下一步进入 Italic。
