...
text marks 当前完成 `bold` / `italic` 的模型表达、helper、校验、规范化、operation 保留和 history 快照保留；Bold 与 Italic 已具备 command、`toggle_mark`、renderer 输出、demo“加粗/斜体”按钮、JSON 映射展示和 history 记录。下一步进入 Mark 切分与合并。
